function(make_appimage)
	...
	set(list_args ASSETS SHARED_LIBS)
...
./${EXE_NAME} $@"
    ...
    if(ARGS_SHARED_LIBS)
        execute_process(COMMAND ${CMAKE_COMMAND} -E make_directory "${APPDIR}/usr/lib")
        execute_process(COMMAND ${CMAKE_COMMAND} -E copy_if_different ${ARGS_SHARED_LIBS} "${APPDIR}/usr/lib")
    endif()
