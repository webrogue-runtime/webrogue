...
#define WABT_FEATURE(variable, flag, default_, help)                           \
    bool variable##_enabled() const {                                          \
        return variable##_enabled_;                                            \
    }                                                                          \
    void enable_##variable() {                                                 \
        set_##variable##_enabled(true);                                        \
    }                                                                          \
    void disable_##variable() {                                                \
        set_##variable##_enabled(false);                                       \
    }                                                                          \
