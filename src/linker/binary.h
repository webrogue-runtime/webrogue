...
enum class NameSectionSubsection {
    ...
    // include names for Tags in wabt using this enum value on the basis that
    // tags can only exist when exceptions are enabled and that engines should
    // ignore unknown name types.
    Tag = 10,
