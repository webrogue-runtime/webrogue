...
struct OutputBuffer {
    Result WriteToFile(StringRef filename) const;
...
public:
    ...
    Result WriteToFile(StringRef filename) {
...
public:
    ...
    explicit FileStream(StringRef filename, Stream *log_stream = nullptr);
