...
if(NOT CMAKE_Pascal_COMPILER_WORKS)
    ...
    file(COPY "${CMAKE_CURRENT_LIST_DIR}/CMakePascalInformation.cmake" DESTINATION ${CMAKE_CURRENT_BINARY_DIR}/${CMAKE_FILES_DIRECTORY}/CMakeTmp/cmake)
    ...
    file(WRITE ${CMAKE_CURRENT_BINARY_DIR}/${CMAKE_FILES_DIRECTORY}/CMakeTmp/CMakeLists.txt
         "set(CMAKE_MODULE_PATH ${CMAKE_CURRENT_SOURCE_DIR}/cmake)
          ...
          project(test Pascal C)
          add_executable(testpascalcompiler testpascalcompiler.pas)

            set_target_properties(testpascalcompiler PROPERTIES LINKER_LANGUAGE C)
         ")
