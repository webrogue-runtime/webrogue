...
set(CMAKE_Pascal_CREATE_SHARED_LIBRARY "echo 'Pascal linker not implemented. Use C linker'")
set(CMAKE_Pascal_CREATE_SHARED_MODULE "echo 'Pascal linker not implemented. Use C linker'")
set(CMAKE_Pascal_CREATE_STATIC_LIBRARY "echo 'Pascal linker not implemented. Use C linker'")
...
if(NOT CMAKE_Pascal_COMPILE_OBJECT)
    ...
    set(CMAKE_Pascal_COMPILE_OBJECT
        "<CMAKE_Pascal_COMPILER> -Cn -FE${EXECUTABLE_OUTPUT_PATH} -FU${CMAKE_CURRENT_BINARY_DIR}/<OBJECT_DIR> ${CMAKE_Pascal_UNIX_FLAGS} <FLAGS> <CMAKE_Pascal_LINK_FLAGS> <SOURCE> -Fu${WEBROGUE_PASCAL_TOOLCHAIN_UNITS}/* -Fu${WEBROGUE_PASCAL_TOOLCHAIN_UNITS}/rtl")
...
if(NOT CMAKE_Pascal_LINK_EXECUTABLE)
    ...
    # endif(WIN32)
    set(CMAKE_Pascal_LINK_EXECUTABLE "sh -c \"wasm-ld CMakeFiles/<TARGET_BASE>.dir/*.o /home/someone/repos/webrogue/mods/langExamplePascal/rtl.a -o <TARGET_BASE> <LINK_FLAGS>  <FLAGS>  <LINK_LIBRARIES> --no-entry\"")
